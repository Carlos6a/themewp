<?php
/**
 * Practicas C6 functions and definitions
 *
...
if ( ! function_exists( 'testing_setup' ) ) :
	/**
	...
	function testing_setup() {
		 ...
		 * If you're building a theme based on Practicas C6, use a find and replace
		...
		add_theme_support( 'custom-background', apply_filters( 'testing_custom_background_args', array(
...
function testing_scripts() {
	wp_enqueue_style( 'testing-style', get_stylesheet_uri() );

	wp_enqueue_script( 'testing-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'testing-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
